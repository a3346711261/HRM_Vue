      ...
      <div v-show="regShow">
        <el-form :model="regForm" :rules="loginRules" ref="regForm" label-position="left">
            ...
            <!-- <el-form-item prop="company">
              <el-input name="company" type="text" clearable v-model="regForm.company" placeholder="请输入您的公司名" />
            </el-form-item> -->
...
export default {
  ...
  methods: {
    ...
    handleLogin(callback) {
      // alert(this.$refs.regFormInfo.validate);
