      ...
      <div class="clearfix">
        <div class='fl headL'>
          ...
          <div class="headInfoTip">
            ...
            <p class="lastChild">HR 专员  |  XXXX-总部-人力资源中心-招聘专员</p>
          </div>
        </div>
        <div class="fr">
                ...
                <ul class="noticeList">
                  <li>
                    <div class="item">
                        ...
                        <div>
                          <p><span class="col">朱元璋</span> 发不了 天下是朕的</p>
                  ...
                  <li>
                    <div class="item">
                        <img  src="./../../assets/img.jpeg" alt="">
                        <div>
                          <p><span class="col">曹操</span> 发布了 领教我负天下人</p>
                          <p>2018-07-21 15:21:38</p>
                        </div>
                      </div>
                  </li>
                  <li>
                    <div class="item">
                        <img  src="./../../assets/img.jpeg" alt="">
                        <div>
                          <p><span class="col">嬴政</span> 发布了 天下的货币应该统一了</p>
                          <p>2018-07-21 15:21:38</p>
                        </div>
                      </div>
                  </li>
                  <li>
                    <div class="item">
                        <img  src="./../../assets/img.jpeg" alt="">
                        <div>
                          <p><span class="col">李世民</span> 发布了 我老李也做皇帝了</p>
                          <p>2018-07-21 15:21:38</p>
                        </div>
                      </div>
                  </li>
                  <li>
                    <div class="item">
                        <img  src="./../../assets/img.jpeg" alt="">
                        <div>
                          <p><span class="col">商纣</span> 发布了 有妲己在身边孤就有千万兵马</p>
                          <p>2018-07-21 15:21:38</p>
                        </div>
                      </div>
                  </li>
                  <li>
                    <div class="item">
                        <img  src="./../../assets/img.jpeg" alt="">
                        <div>
                          <p><span class="col">孙武</span> 发布了 君主是有事爱才，无事毁才</p>
                          <p>2018-07-21 15:21:38</p>
                        </div>
                      </div>
                  </li>
